...
| v1.3.5 | Strategy Knowledge Empirical Backtest | Done |
...
| v1.4.5 | Source Lineage & Rate Limit | Planned |
...
### v1.3.7 — Strategy Robustness & Regime Validation ✅

- **Version:** 1.3.7 — Strategy Robustness & Regime Validation *(originally developed under internal label 1.4.2; Git commit history unchanged)*
...
- **Changes:** strategy_robustness/ package (23 modules), gui/strategy_robustness_panel.py (16-tab QWidget), main.py (robustness CLI commands + version-info flags), release/version_info.py (VERSION→1.3.7, 13 new flags, canonical mapping), release/version_alignment.py (canonical mapping module), tests/test_strategy_robustness_v142.py (168 tests), tests/test_version_alignment_v137.py (60 alignment tests), tests/fixtures/strategy_robustness/ (10 JSON fixtures), .gitignore (data/strategy_robustness/ and related paths), docs/strategy_robustness_regime_validation_v1.4.2.md.
...
### v1.3.6 — A/B/C Buy Point Validation ✅

- **Version:** 1.3.6 — A/B/C Buy Point Validation *(originally developed under internal label 1.4.1; Git commit history unchanged)*
...
- **Changes:** abc_validation/ package (25 modules), gui/abc_buy_point_validation_panel.py (15-tab QWidget), main.py (19 new CLI handler functions), release/version_info.py (12 new flags), tests/test_abc_validation_v141.py (182 tests), tests/fixtures/abc_validation/ (10 JSON fixtures), docs/abc_buy_point_validation_v1.4.1.md.
- **Safety:** NO_REAL_ORDERS=True; BROKER_EXECUTION_ENABLED=False; PRODUCTION_TRADING_BLOCKED=True; MOCK_FORMAL_CONCLUSION_ALLOWED=False; AUTO_OPTIMIZATION_ENABLED=False; AUTO_TRADING_ENABLED=False; Fixture data blocked in real mode; Not Investment Advice.

---

### v1.3.5 — Strategy Knowledge Empirical Backtest ✅

- **Version:** 1.3.5 — Strategy Knowledge Empirical Backtest *(originally developed under internal label 1.4.0; Git commit history unchanged)*
