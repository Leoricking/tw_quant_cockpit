...
REPORT_DATA_STABILIZATION  = "data_stabilization"
REPORT_REPLAY_TRAINING     = "replay_training"
REPORT_STABLE_RELEASE_V060 = "stable_release_v060_report"
REPORT_RELEASE_MANIFEST    = "release_manifest"
# v0.6.2 Data Coverage Expansion
REPORT_DATA_COVERAGE       = "data_coverage"
# v0.7.0 Research Intelligence
REPORT_RESEARCH_INTELLIGENCE = "research_intelligence"
# v0.7.2 Strategy Research Memory
REPORT_STRATEGY_MEMORY = "strategy_memory"
# v0.7.3 Backtest-to-Coach Loop
REPORT_BACKTEST_COACH  = "backtest_coach"
