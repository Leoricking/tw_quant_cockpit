...
def test_version_info_112():
    ...
    assert VERSION.startswith("1.3.") or VERSION.startswith("1.4.") or VERSION.startswith("1.5.") or VERSION.startswith("1.6.") or VERSION.startswith("1.7."), f"Expected 1.3.x-1.7.x, got {VERSION}"
