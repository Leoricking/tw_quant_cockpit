...
def test_panel_version_195():
    assert PANEL_VERSION in ("1.9.5", "1.9.6", "1.9.7", "1.9.8", "1.9.9", "1.9.10", "2.0.0")


def test_panel_title_contains_195():
    assert "1.9.5" in PANEL_TITLE or "1.9.6" in PANEL_TITLE or "1.9.7" in PANEL_TITLE or "1.9.8" in PANEL_TITLE or "1.9.9" in PANEL_TITLE or "1.9.10" in PANEL_TITLE or "2.0.0" in PANEL_TITLE


def test_panel_title_contains_review_or_approval():
    assert "Review" in PANEL_TITLE or "Approval" in PANEL_TITLE or "Governance" in PANEL_TITLE or "Dashboard" in PANEL_TITLE or "Portfolio" in PANEL_TITLE or "Cockpit" in PANEL_TITLE or "Console" in PANEL_TITLE
...
def test_get_panel_info_panel_version():
    assert get_panel_info()["panel_version"] in ("1.9.5", "1.9.6", "1.9.7", "1.9.8", "1.9.9", "1.9.10", "2.0.0")
