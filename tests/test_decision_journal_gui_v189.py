...
def test_panel_version_is_189():
    assert PANEL_VERSION == "1.8.9"


def test_panel_title_contains_189():
    assert "1.8.9" in PANEL_TITLE


def test_panel_title_contains_journal():
    assert "Journal" in PANEL_TITLE or "journal" in PANEL_TITLE.lower()
...
def test_get_panel_info_panel_version():
    assert get_panel_info()["panel_version"] == "1.8.9"
