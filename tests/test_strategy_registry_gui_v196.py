...
def test_panel_version_196():
    assert PANEL_VERSION in ("1.9.6", "1.9.7", "1.9.8")

def test_panel_title_contains_196():
    assert "1.9.6" in PANEL_TITLE or "1.9.7" in PANEL_TITLE or "1.9.8" in PANEL_TITLE

def test_panel_title_contains_registry_or_governance():
    assert "Registry" in PANEL_TITLE or "Governance" in PANEL_TITLE or "Decision" in PANEL_TITLE
...
def test_get_panel_info_panel_version():
    assert get_panel_info()["panel_version"] in ("1.9.6", "1.9.7", "1.9.8")
