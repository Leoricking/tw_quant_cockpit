...
def test_panel_version_is_190():
    assert PANEL_VERSION in ("1.9.0", "1.9.1", "1.9.2", "1.9.3")


def test_panel_title_contains_190():
    assert "1.9.0" in PANEL_TITLE or "1.9.1" in PANEL_TITLE or "1.9.2" in PANEL_TITLE or "1.9.3" in PANEL_TITLE


def test_panel_title_contains_performance_or_review():
    assert "Performance" in PANEL_TITLE or "Review" in PANEL_TITLE or "Tuning" in PANEL_TITLE or "Sandbox" in PANEL_TITLE or "Promotion" in PANEL_TITLE or "Rollback" in PANEL_TITLE
...
def test_get_panel_info_panel_version():
    assert get_panel_info()["panel_version"] in ("1.9.0", "1.9.1", "1.9.2", "1.9.3")
