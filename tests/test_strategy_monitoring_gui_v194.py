...
def test_panel_version_194():
    assert PANEL_VERSION == "1.9.4"


def test_panel_title_contains_194():
    assert "1.9.4" in PANEL_TITLE


def test_panel_title_contains_monitoring():
    assert "Monitoring" in PANEL_TITLE or "Drift" in PANEL_TITLE
...
def test_get_panel_info_panel_version():
    assert get_panel_info()["panel_version"] == "1.9.4"
