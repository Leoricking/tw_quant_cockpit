...
class TestVersionInfo:
    ...
    def test_2_release_name(self):
        ...
        assert RELEASE_NAME in ("Provider Stable Rollup", "Portfolio Research Foundation", "Portfolio Research Foundation Integrity Hotfix", "Portfolio Research CLI Completeness Hotfix", "Position Sizing", "Correlation & Exposure", "Drawdown & Risk Controls", "Portfolio Walk-forward Backtest", "Portfolio Stable Rollup")

    def test_3_base_release_contains_148(self):
        from release.version_info import BASE_RELEASE
        assert "1.4.8" in BASE_RELEASE or "1.4.9" in BASE_RELEASE or "1.5.0" in BASE_RELEASE or "1.5.1" in BASE_RELEASE
