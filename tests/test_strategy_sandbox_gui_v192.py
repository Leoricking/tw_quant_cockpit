...
def test_panel_version_192():
    assert PANEL_VERSION in ("1.9.2", "1.9.3", "1.9.4", "1.9.5", "1.9.6", "1.9.7", "1.9.8", "1.9.9")
...
def test_get_panel_info_panel_version_192():
    assert get_panel_info()["panel_version"] in ("1.9.2", "1.9.3", "1.9.4", "1.9.5", "1.9.6", "1.9.7", "1.9.8", "1.9.9")
