"""
tests/test_strategy_registry_health_v196.py
Tests for strategy_registry_health_v196 — Paper Strategy Decision Registry & Governance Lab v1.9.6.
...
def test_health_check_has_all_passed():
    assert "all_passed" in run_health_check()

def test_health_check_has_status():
    assert "status" in run_health_check()

def test_health_check_has_passed():
    assert "passed" in run_health_check()

def test_health_check_has_failed():
    assert "failed" in run_health_check()

def test_health_check_has_total():
    assert "total" in run_health_check()

def test_health_check_has_checks():
...
def test_health_check_governance_only():
    assert run_health_check()["governance_only"] is True

def test_health_check_registry_only():
    assert run_health_check()["registry_only"] is True

def test_health_check_no_real_orders():
    assert run_health_check()["no_real_orders"] is True

def test_health_check_schema_version():
    assert run_health_check()["schema_version"] == "196"
...
def test_health_check_checks_not_empty():
