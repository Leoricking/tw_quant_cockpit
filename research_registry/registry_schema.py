...
class ResearchRunRecord:
    ...
    registry_id: str
    run_id: str
    run_type: str  # BACKTEST/VALIDATION/SCREENER/REPORT/PREVIEW/GATE_ENFORCEMENT/GOVERNANCE/GOVERNANCE_ALERTS/DATA_IMPORT/DATA_REPAIR/DATA_FRESHNESS/QUALITY_GATE/PAPER_SIMULATION/MOCK_SIMULATION/SYSTEM_HEALTH/REPLAY_REVIEW_DASHBOARD_BUILT/REPLAY_REVIEW_QUEUE_UPDATED/REPLAY_REVIEW_PROGRESS_UPDATED/REPLAY_REVIEW_OUTCOME_REVEALED/REPLAY_REVIEW_NOTE_ADDED/CHALLENGE_CREATED/CHALLENGE_STARTED/CHALLENGE_PAUSED/CHALLENGE_RESUMED/CHALLENGE_COMPLETED/CHALLENGE_TIMEOUT/CHALLENGE_CANCELLED/CHALLENGE_HINT_USED/CHALLENGE_REVIEWED/CHALLENGE_RESULT_CREATED/CHALLENGE_BATCH_COMPLETED/OTHER
    command_name: str
