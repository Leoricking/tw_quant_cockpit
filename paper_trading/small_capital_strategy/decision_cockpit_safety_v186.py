"""
paper_trading/small_capital_strategy/decision_cockpit_safety_v186.py
Safety flags for End-to-End Small Capital Decision Cockpit v1.8.6.
...
_MUST_BE_TRUE = [
    ...
    "decision_only", "no_real_orders", "no_broker", "no_margin",
