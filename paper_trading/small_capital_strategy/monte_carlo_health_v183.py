...
def run_health_check():
    ...
    checks.append(_check("gui_panel_version_183", lambda: PANEL_VERSION in ("1.8.3", "1.8.4", "1.8.5", "1.8.6", "1.8.7", "1.8.8", "1.8.9", "1.9.0", "1.9.1", "1.9.2", "1.9.3", "1.9.4", "1.9.5", "1.9.6", "1.9.7", "1.9.8")))
