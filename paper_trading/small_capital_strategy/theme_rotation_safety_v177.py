"""
paper_trading/small_capital_strategy/theme_rotation_safety_v177.py
Safety flags for Theme Rotation Scanner v1.7.7.
...
THEME_ROTATION_AVAILABLE      = True
THEME_ROTATION_RESEARCH_ONLY  = True
THEME_ROTATION_PAPER_ONLY     = True
THEME_ROTATION_READ_ONLY      = True
THEME_ROTATION_DETERMINISTIC  = True
THEME_ROTATION_NOT_INVESTMENT_ADVICE = True
