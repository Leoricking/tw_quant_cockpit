"""
paper_trading/small_capital_strategy/portfolio_construction_safety_v185.py
Safety flags for Portfolio Construction & Rebalancing Lab v1.8.5.
...
_MUST_BE_TRUE = [
    ...
    "portfolio_only", "no_real_orders", "no_broker", "no_margin",
