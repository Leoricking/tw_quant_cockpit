"""
paper_trading/small_capital_strategy/decision_cockpit_fixtures_v186.py
Fixture registry for End-to-End Small Capital Decision Cockpit v1.8.6.
...
_FIXTURE_DIR = _os.path.join(
    ...
    "..", "..", "tests", "fixtures", "decision_cockpit",
)
