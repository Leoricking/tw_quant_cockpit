...
ALLOWED_COMMAND_PREFIXES = [
    ...
    "replay-mtf-summary",
    "replay-mtf-report",
    "replay-mtf-timeline-report",
    "replay-mtf-batch-preview",
    "replay-mtf-firewall-check",
    "replay-mtf-pit-check",
    "replay-mtf-compare",
    "replay-mtf-store-check",
    # v1.2.7 Replay Challenge Mode commands
    "replay-challenge-health",
    "replay-challenge-list",
    "replay-challenge-search",
    "replay-challenge-show",
    "replay-challenge-templates",
    "replay-challenge-preview",
    "replay-challenge-attempt",
    "replay-challenge-result",
    "replay-challenge-progress",
    "replay-challenge-streak",
    "replay-challenge-badges",
    "replay-challenge-leaderboard",
    "replay-challenge-compare",
    "replay-challenge-summary",
    "replay-challenge-type-summary",
    "replay-challenge-difficulty-summary",
    "replay-challenge-report",
    "replay-challenge-summary-report",
    "replay-challenge-progress-report",
...
_POLICIES: Dict[str, dict] = {
    ...
    # v1.2.5 Multi-Timeframe Replay alert types
    "MTF_FUTURE_KLINE_DETECTED": {
        "severity": "CRITICAL", "priority": "P0",
        "suppression_window": 0,
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
        "suggested_commands": ["replay-timeframe-health", "replay-mtf-firewall-check"],
        "permanent_suppress_allowed": False,
    },
    "MTF_AUTO_TRADE_ENABLED": {
        ...
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
        "suggested_commands": ["replay-timeframe-health"],
        "permanent_suppress_allowed": False,
    },
    ...
    "MTF_BFILL_DETECTED": {
        ...
        "snooze_limit": 86400,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
        "suggested_commands": ["replay-timeframe-health", "replay-mtf-pit-check"],
        "permanent_suppress_allowed": False,
    },
    "MTF_PARTIAL_BAR_CONFIRMED_SIGNAL": {
        "severity": "HIGH", "priority": "P1",
        "suppression_window": 1800,
        "snooze_limit": 86400,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
    ...
    # v1.2.7 Replay Challenge Mode alerts
    "REPLAY_CHALLENGE_FUTURE_DATA_LEAK": {
        "severity": "CRITICAL", "priority": "P0",
        "suppression_window": 0,
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "READ_REPORT"],
        "suggested_commands": ["replay-challenge-health"],
        "permanent_suppress_allowed": False,
    },
    "REPLAY_CHALLENGE_OUTCOME_LEAK": {
        "severity": "CRITICAL", "priority": "P0",
        "suppression_window": 0,
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "READ_REPORT"],
    ...
    "REPLAY_CHALLENGE_ANSWER_KEY_LEAK": {
        "severity": "CRITICAL", "priority": "P0",
        "suppression_window": 0,
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "READ_REPORT"],
    ...
    "REPLAY_CHALLENGE_AUTO_DECISION_ATTEMPT": {
        "severity": "HIGH", "priority": "P1",
        "suppression_window": 1800,
        "snooze_limit": 86400,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
    ...
    "REPLAY_CHALLENGE_AUTO_REVEAL_ATTEMPT": {
        "severity": "HIGH", "priority": "P1",
        "suppression_window": 1800,
        "snooze_limit": 86400,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
    ...
    "REPLAY_CHALLENGE_AUTO_CONFIRM_ATTEMPT": {
        "severity": "HIGH", "priority": "P1",
        "suppression_window": 1800,
        "snooze_limit": 86400,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
    ...
    "REPLAY_CHALLENGE_SCORE_TO_TRADE_ATTEMPT": {
        "severity": "CRITICAL", "priority": "P0",
        "suppression_window": 0,
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "READ_REPORT"],
    ...
    "REPLAY_CHALLENGE_STORE_CORRUPTED": {
        "severity": "HIGH", "priority": "P1",
        "suppression_window": 1800,
        "snooze_limit": 86400,
        "safe_actions": ["VERIFY_AUDIT", "REVIEW"],
        "suggested_commands": ["replay-challenge-health", "replay-challenge-summary"],
        "permanent_suppress_allowed": False,
    },
    "REPLAY_CHALLENGE_NETWORK_SUBMISSION_ATTEMPT": {
        "severity": "CRITICAL", "priority": "P0",
        "suppression_window": 0,
        "snooze_limit": None,
        "safe_actions": ["VERIFY_AUDIT", "READ_REPORT"],
