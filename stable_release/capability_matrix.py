...
class StableCapabilityMatrix:
    ...
    def build(self) -> "StableCapabilityMatrix":
        ...
        self._capabilities = [
            ...
            # v0.7.2 Strategy Research Memory (updated v0.8.1: UX polish)
            StableCapability(
                ...
                known_limitations=[
                    ...
                    "ACCEPTED status means research accepted, not trading enabled",
                ],
                no_real_orders=True,
                production_blocked=True,
            ),
            ...
            StableCapability(
                capability_id="strategy_memory_ux",
                ...
                cli_commands=[
                    ...
                    "strategy-memory-list --needs-action",
                    "strategy-memory-search --needs-action",
                    "strategy-memory-search --source-module",
                ],
                gui_tabs=["Strategy Memory"],
                reports=["strategy_memory"],
                regression_coverage=True,
                ...
                known_limitations=[
                    ...
                    "No BUY/SELL/ORDER commands produced",
                    "All safe commands labelled SAFE_READ_ONLY/SAFE_REPORT/SAFE_REGRESSION/SAFE_REPLAY/SAFE_DATA_CHECK",
                ],
                no_real_orders=True,
                production_blocked=True,
            ),
