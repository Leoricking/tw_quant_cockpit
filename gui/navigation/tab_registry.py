...
class GUITabRegistry:
    ...
    def _build_registry(self) -> None:
        ...
        tabs = [
            ...
            GUITabMetadata(
                tab_id="data_providers",
                tab_name="data_providers",
                display_name="Real Data Providers",
                group="data",
                priority="P1",
                description="Real Data Provider Adapter — provider registry, capability matrix, request inspector, provenance",
                module_path="gui.real_data_provider_panel",
                class_name="RealDataProviderPanel",
                available_flag="_REAL_DATA_PROVIDER_PANEL_AVAILABLE",
                keywords=["provider", "data provider", "real data", "capability", "provenance",
                          "cache", "retry", "資料來源", "真實資料", "供應商", "資料能力",
                          "來源追蹤", "快取", "重試"],
                related_cli_commands=["provider-list", "provider-show", "provider-capabilities",
                                      "provider-status-v132", "provider-health-v132",
                                      "provider-request", "provider-cache-status", "provider-provenance"],
                maturity="STABLE",
                notes="v1.3.2. No Live Connection. No Auto Download. No Credentials. Research Only.",
            ),
            GUITabMetadata(
            ...
            # replay_stable (v1.2.9)
            GUITabMetadata(
                tab_id="replay_stable",
                tab_name="Replay Stable",
                display_name="Replay Training Stable Rollup",
                group="research",
                priority="P0",
                description="v1.2.9 Replay Training Stable Rollup: manifests, capability matrix, cross-module contracts, backward compatibility, audits, release gate.",
                module_path="gui.replay_stable_rollup_panel",
                class_name="ReplayStableRollupPanel",
                available_flag="_REPLAY_STABLE_AVAILABLE",
                safety_level="RESEARCH_ONLY",
                read_only=True,
                no_real_orders=True,
                production_blocked=True,
                keywords=[
                    "stable", "rollup", "manifest", "capability", "contract",
                    "backward compatibility", "audit", "release gate",
                    "replay training", "v1.2.9",
                ],
                related_cli_commands=[
                ...
                report_types=[
                    "replay_training_stable_rollup_report",
                    "replay_stable_summary_report",
                    "replay_stable_capability_report",
                ],
                maturity="STABLE",
                default_visible=True,
                favorite_default=False,
                notes="Added in v1.2.9 \u2014 Replay Training Stable Rollup. RESEARCH ONLY. No Real Orders. No Broker. Replay Training v1.2 line complete.",
            ),
        ]
        for tab in tabs:
