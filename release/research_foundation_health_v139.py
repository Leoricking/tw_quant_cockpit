...
class ResearchFoundationStableHealthCheck:
    ...
    def _check_version(self, checks: dict) -> None:
        ...
        try:
            ...
            ok = any(marker in BASE_RELEASE for marker in ("1.3.7", "1.3.9", "1.4.0", "1.4.1", "1.4.2", "1.4.3", "1.4.4", "1.4.5", "1.4.6", "1.4.7", "1.4.8", "1.4.9", "1.5.0", "1.5.0.2"))
    ...
    def _check_capabilities(self, checks: dict) -> None:
        ...
        still_planned_caps: list = []  # v1.4.7: forum_intelligence promoted to STABLE
        ...
        progressed_caps = [
            ...
            "forum_intelligence",  # v1.4.7: promoted from PLANNED to STABLE
        ]
