...
class StrategyMonitoringReleaseGate:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        self._gate("gui_panel_version_194", lambda: PANEL_VERSION in ("1.9.4", "1.9.5", "1.9.6", "1.9.7", "1.9.8", "1.9.9", "1.9.10", "2.0.0"))
        ...
        self._gate("backward_compat_panel_version",
                   lambda: get_panel_info()["panel_version"] in ("1.9.4", "1.9.5", "1.9.6", "1.9.7", "1.9.8", "1.9.9", "1.9.10", "2.0.0"))
