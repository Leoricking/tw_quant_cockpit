"""
release/version_info.py — Centralized version info for TW Quant Cockpit v1.0.2.
...
# ---------------------------------------------------------------------------
# v1.0.2 module-level constants (Data & Report Hygiene)
# ---------------------------------------------------------------------------
VERSION                             = "1.0.2"
RELEASE_NAME                        = "Data & Report Hygiene"
BASE_RELEASE                        = "1.0.0"
