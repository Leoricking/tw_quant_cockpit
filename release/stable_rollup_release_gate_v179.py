...
class StableRollupReleaseGate:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        self._check("gui_panel_version_179",      lambda: run_gui_audit()["panel_version"] in ("1.7.9", "1.8.0", "1.8.1", "1.8.2", "1.8.3"))
        ...
        self._check("gui_panel_version_match",    lambda: PANEL_VERSION in ("1.7.9", "1.8.0", "1.8.1", "1.8.2", "1.8.3"))
